...
void Quad::setCenter(point new_center) {
    center.x = new_center.x;
    center.y = new_center.y;
}

Quad::Quad(color fill) : fill(fill) {}

Quad::Quad(point center) : center(center) {}

Quad::Quad(color fill, point center) : fill(fill), center(center) {}
